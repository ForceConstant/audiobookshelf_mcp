#!/bin/bash
set -x
docker run -it --rm -w /workspace -v /mnt/volume/devel/audiobookshelf_mcp:/workspace openapi-mcp-generator openapi-mcp-generator --input external/audiobookshelf/docs/openapi.json --output /workspace/audiobookshelf_mcp --transport=streamable-http --port=3000
